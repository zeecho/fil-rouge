...
use SerieBundle\Form\LanguageType;
...
class LanguageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $languages = $em->getRepository('SerieBundle:Language')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SerieBundle\Form\LanguageType', $language);
    ...
    {
        $deleteForm = $this->createDeleteForm($language);
        $editForm = $this->createForm('SerieBundle\Form\LanguageType', $language);
