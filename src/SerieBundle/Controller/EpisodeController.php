...
class EpisodeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $episodes = $em->getRepository('SerieBundle:Episode')->findAll();
    ...
    {
        $episode = new Episode();
        $form = $this->createForm('SerieBundle\Form\EpisodeType', $episode);
    ...
    {
        $deleteForm = $this->createDeleteForm($episode);
        $editForm = $this->createForm('SerieBundle\Form\EpisodeType', $episode);
