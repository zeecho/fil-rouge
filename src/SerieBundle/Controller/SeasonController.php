...
class SeasonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $seasons = $em->getRepository('SerieBundle:Season')->findAll();
    ...
    {
        $season = new Season();
        $form = $this->createForm('SerieBundle\Form\SeasonType', $season);
    ...
    {
        $deleteForm = $this->createDeleteForm($season);
        $editForm = $this->createForm('SerieBundle\Form\SeasonType', $season);
