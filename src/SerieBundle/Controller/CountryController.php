...
use SerieBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $countries = $em->getRepository('SerieBundle:Country')->findAll();
    ...
    {
        $country = new Country();
        $form = $this->createForm('SerieBundle\Form\CountryType', $country);
    ...
    {
        $deleteForm = $this->createDeleteForm($country);
        $editForm = $this->createForm('SerieBundle\Form\CountryType', $country);
