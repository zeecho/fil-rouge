...
use SerieBundle\Form\PersonType;
...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $people = $em->getRepository('SerieBundle:Person')->findAll();
    ...
    {
        $person = new Person();
        $form = $this->createForm('SerieBundle\Form\PersonType', $person);
    ...
    {
        $deleteForm = $this->createDeleteForm($person);
        $editForm = $this->createForm('SerieBundle\Form\PersonType', $person);
