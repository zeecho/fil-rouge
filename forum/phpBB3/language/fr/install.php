...
$lang = array_merge($lang, array(
	...
	'BOARD_NOT_INSTALLED_EXPLAIN'	=> 'Le « phpBB Unified Convertor Framework » requiert une installation vierge de phpBB3 pour fonctionner. Procédez <a href="%s">à une première installation de phpBB3</a>.',
	'BACKUP_NOTICE'					=> 'Sauvegardez votre forum avant de le mettre à jour dans le cas où des problèmes surviendraient pendant le processus de mise à jour.',

	'CATEGORY'					=> 'Catégorie',
	'CACHE_STORE'				=> 'Type de cache',
	'CACHE_STORE_EXPLAIN'		=> 'Emplacement physique où les données sont mises en cache, le système de fichiers est préférable.',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Vous avez converti votre forum vers phpBB 3.1. Assurez-vous que les paramètres aient été correctement transférés avant d’activer votre forum en supprimant le répertoire « install ». Vous pouvez désormais vous connecter et <a href="../">accéder à votre forum</a>. Souvenez-vous que l’aide sur l’utilisation de phpBB est disponible dans la <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">documentation en ligne</a> (en anglais), les <a href="https://www.phpbb.com/community/viewforum.php?f=46">forums de support officiels</a> et les <a href="http://forums.phpbb-fr.com/">forums de support de phpBB-fr.com</a>.',
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'Le transfert par FTP des fichiers joints est activé sur votre ancien forum. Copiez tous les fichiers joints dans un répertoire, désactivez le transfert FTP, et vérifiez que le répertoire de transfert indiqué est correct. Vous devrez ensuite redémarrer la conversion.',
	...
	'FILES_OPTIONAL_EXPLAIN'	=> '<strong>Optionnel</strong> - Ces fichiers, répertoires ou permissions ne sont pas obligatoires. L’assistant d’installation utilisera diverses techniques pour les créer s’ils n’existent pas ou s’ils ne sont pas accessibles en écriture. Toutefois, leur présence accélérera l’installation.',
	...
	'FORUM_ADDRESS_EXPLAIN'		=> 'Ceci est l’URL de votre ancien forum, par exemple <samp>http://www.exemple.com/phpBB2/</samp>. Si une adresse est entrée ici et non vide à gauche, chaque exemple de cette adresse sera remplacé par votre nouvelle adresse dans les messages, messages privés et signatures.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		Vous avez installé votre forum phpBB %1$s. Choisissez maintenant une des options suivantes :</p>
		...
		<p>En cliquant sur le bouton ci-dessous vous serez redirigé vers un formulaire pour soumettre votre rapport de statistiques à phpBB dans votre panneau d’administration (PCA). Nous apprécierions si vous pouviez nous aider en envoyant cette information. Prenez le temps d’examiner les différentes options disponibles. Souvenez-vous qu’une aide est accessible via la <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">documentation en ligne</a> (en anglais), le fichier <a href="%3$s">README</a> (en anglais), les <a href="https://www.phpbb.com/community/viewforum.php?f=466">forums de support officiels</a> et les <a href="http://forums.phpbb-fr.com/">forums de support de phpBB-fr.com</a>.</p><p><strong>Effacez, renommez ou déplacez le répertoire « install » de votre FTP avant d’utiliser votre forum. Tant que ce répertoire est présent, seul le panneau d’administration (PCA) sera disponible.</strong>',
	...
	'PHP_JSON_SUPPORT_EXPLAIN'			=> '<strong>Requis</strong> - Pour que phpBB fonctionne correctement, l’extension JSON pour PHP doit être disponible.',
	'PHP_OPTIONAL_MODULE'				=> 'Modules optionnels',
	'PHP_OPTIONAL_MODULE_EXPLAIN'		=> '<strong>Optionnel</strong> - Ces modules ou applications sont optionnels, vous n’en avez pas besoin pour utiliser phpBB 3.1. Toutefois si vous les avez, ils activeront des fonctionnalités supplémentaires.',
	...
	'PHP_SETTINGS_EXPLAIN'				=> '<strong>Requis</strong> - Vous devez utiliser au moins la version 5.3.3 de PHP pour installer phpBB. Si <var>safe mode</var> est affiché, PHP fonctionne dans ce mode. Cela implique des limitations sur l’administration distante et des fonctionnalités similaires.',
	...
	'SELECT_FORUM_GA'			=> 'Dans phpBB 3.1, les annonces globales sont liées à des forums. Sélectionnez un forum pour votre annonce globale actuelle (peut être déplacée plus tard) :',
	...
	'STAGE_ADVANCED_EXPLAIN'	=> 'Les paramètres de cette page ne sont nécessaires que pour définir des paramètres différents de ceux par défaut. En cas de doute, allez à la page suivante, ils pourront être modifiés plus tard via le « Panneau d’administration ».',
	'STAGE_CONFIG_FILE'			=> 'Fichier de configuration',
	'STAGE_CREATE_TABLE'		=> 'Création des tables de base de données',
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'Les tables de la base de données utilisées par phpBB 3.1 ont été créées et remplies avec quelques données initiales. Rendez-vous sur la page suivante pour terminer l’installation de phpBB.',
	...
	'TESTS_FAILED'				=> 'Échec des vérifications',
	...
	'WELCOME_INSTALL'			=> 'Bienvenue dans l’installation de phpBB3',
	'WRITABLE'					=> 'Autorisé en écriture',
));

// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Tous les fichiers ont été mis à jour.',
	...
	'COMPLETE_LOGIN_TO_BOARD'		=> 'Vous pouvez maintenant vous <a href="../ucp.php?mode=login">connecter à votre forum</a> et vérifier si tout fonctionne correctement. N’oubliez pas de supprimer, renommer ou déplacer le répertoire <em>install</em> !',
	...
	'DATABASE_UPDATE_COMPLETE'			=> 'Le processus de mise à jour de la base de données est terminé !',
	'DATABASE_UPDATE_CONTINUE'			=> 'Poursuivre la mise à jour de la base de données',
	'DATABASE_UPDATE_INFO_OLD'			=> 'Le fichier de mise à jour de la base de données se trouvant dans le répertoire « install » est obsolète. Vérifiez que vous avez transféré la bonne version du fichier.',
	'DATABASE_UPDATE_NOT_COMPLETED'		=> 'Le processus de mise à jour de la base de données est en cours.',
	...
	'ERROR'			=> 'Erreur',
	'EVERYTHING_UP_TO_DATE'		=> 'Tout a été mis à jour. Vous devriez maintenant <a href="%1$s">vous connecter à votre forum</a> afin de vérifier que tout fonctionne correctement. N’oubliez pas de supprimer, renommer ou déplacer le répertoire « install » de votre système ! Merci de nous envoyer les informations mises à jour au sujet de votre serveur et les configurations de votre forum depuis le module <a href="%2$s">d’envoi du rapport de statistiques</a> dans le panneau d’administration.',
	...
	'MAPPING_FILE_STRUCTURE'	=> 'Pour faciliter le transfert, voici les emplacements des fichiers qui correspondent à votre installation de phpBB.',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'Aucun répertoire de mise à jour valide n’a été trouvé, assurez-vous de bien avoir transféré les fichiers nécessaires.<br /><br />Votre installation ne semble <strong>pas</strong> à jour. Des mises à jour sont disponibles pour votre version de phpBB %1$s, visitez <a href="https://www.phpbb.com/downloads/" rel="external">https://www.phpbb.com/downloads/</a> afin d’obtenir le pack correct pour mettre à jour votre Version %2$s vers la Version %3$s.',
	...
	'NUMBER_OF_FILES_COLLECTED'		=> 'Actuellement, %1$d des %2$d fichiers comportant des différences ont été vérifiés.<br />Patientez jusqu’à ce que la vérification des fichiers soit terminée.',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Vous trouverez aussi dans le tutoriel de mise à jour toutes les instructions pour mettre à jour vos styles autre que Prosilver ou Subsilver2.</p>
	',
	'UPDATE_METHOD'					=> 'Méthode de mise à jour',
	'UPDATE_METHOD_EXPLAIN'			=> 'Vous pouvez maintenant choisir votre méthode de mise à jour préférée. En utilisant le transfert FTP, vous devrez saisir les informations de votre compte FTP dans un formulaire. Avec cette méthode, les fichiers seront déplacés automatiquement vers le nouvel emplacement et des sauvegardes des anciens fichiers seront créées en ajoutant .bak au nom du fichier. Si vous choisissez de télécharger les fichiers modifiés, vous pourrez les décompresser et les transférer manuellement vers leur emplacement correct plus tard.',
	...
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Votre installation de phpBB n’est pas à jour.<br />Vous trouverez ci-dessous un lien vers l’annonce de publication qui contient plus d’informations comme les instructions de mise à jour.',
