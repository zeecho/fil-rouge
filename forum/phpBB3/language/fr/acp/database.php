...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'Ici, Vous pouvez sauvegarder l’intégralité des données de votre forum. Vous pouvez stocker l’archive de sauvegarde dans votre dossier <samp>store/</samp> ou la télécharger. Selon la configuration de votre serveur, vous pouvez utiliser différents formats de compression.',
